...
Note that Anipaca will download from up to five different sources in parallel.

## Why did my downloads stop midway?
Downloads stopping midway may be related to network connection issues or source problems.
**Anipaca** will provide notifications regarding encountered errors during download attempts.
...
**Anipaca** typically prevents series images/videos in downloads from appearing in your device's photo gallery by default through a `.nomedia` file.
